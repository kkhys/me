...
// through innerHTML: the indexed text contains HTML (code samples, prose, and
// titles fetched from external sites for link cards), and relying on
// Pagefind's runtime escaping to keep that inert ties safety to an
