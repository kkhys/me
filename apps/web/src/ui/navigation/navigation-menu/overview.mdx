...
<Meta of={NavigationMenuStories} name='Overview' />
<Title />
<Subtitle>
  A visually persistent menu common in desktop applications that provides quick access to a consistent set of commands.
</Subtitle>
<Canvas of={NavigationMenuStories.Default} layout='fullscreen' />
<Controls of={NavigationMenuStories.Default} />
...
import { NavigationMenuItem, NavigationMenuLink, navigationMenuTriggerStyle } from '#/ui/navigaton';
...
See also the <a href='https://www.radix-ui.com/docs/primitives/components/navigation-menu#with-client-side-routing' target='_blank' rel='noopener noreferrer'>Radix UI documentation</a> for handling client side routing.

## Reference

- [shadcn/ui](https://ui.shadcn.com/docs/components/navigation-menu)
- [Radix Primitives](https://www.radix-ui.com/primitives/docs/components/navigation-menu)
