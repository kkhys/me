...
高速でタイピング中に、誤って `⌘+Q` を押してしまい、保存していない作業を失った経験から、この 2 連打設定は非常に役立っている。
...
![Warp](/images/tech/2025-03-23/10.png "Warp のシンプルな UI")
...
![iStat Menus](/images/tech/2025-03-23/11.png)

### 31. そのほか

各プログラミング言語と、それをインストールするためのパッケージマネージャは移り変わりが激しいため、ここでは省略する。

Node.js に関しては、以前は [nodenv](https://github.com/nodenv/nodenv) を使っていたが、最近は [Volta](https://volta.sh) が人気のようだ。
