...
export const NowPlaying = ({ initialData }: Props) => {
    ...
    return (
      ...
      >
        <div className="flex flex-col justify-between w-full">
          <div>
            <div className="flex items-center justify-center size-10 shadow-sm rounded-[8px] bg-background border">
              <svg
  ...
  return (
    <a
      ...
      rel="noreferrer"
      className={cn(
        "size-full shadow-input flex justify-between gap-4 shadow-sm rounded-xl border bg-background p-4 transition duration-200 active:scale-95 dark:shadow-none",
        "col-span-1 row-span-1 md:col-span-4 aspect-[2/1]",
      )}
    >
      <div className="flex flex-col justify-between w-full">
