...
export const ThemeSelector: FC<ThemeSelectorProps> = ({ className }) => {
  ...
  return (
    ...
    >
      ...
      <Listbox.Button
        className='flex h-6 w-6 items-center justify-center rounded-lg shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-primary/10 dark:ring-inset dark:ring-white/5'
      ...
      <Listbox.Options className='absolute top-full left-1/2 mt-3 w-36 -translate-x-1/2 space-y-1 rounded-xl bg-white p-3 text-sm font-medium shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-primary/5 dark:ring-white/5'>
        {themes.map((theme) => (
          <Listbox.Option
            key={theme.value}
            value={theme}
